...
static double __pyx_f_9integrate_integrate_cython(PyObject *, double, double, int, int __pyx_skip_dispatch); /*proto*/
...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_9integrate_integrate_cython(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_f, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter); /* proto */
...
#define __pyx_kp_u_integrate_pyx __pyx_string_tab[1]
...
#define __pyx_n_u_integrate __pyx_string_tab[9]
#define __pyx_n_u_integrate_cython __pyx_string_tab[10]
...
#define __pyx_kp_b_iso88591_Q_a_Cr_U_1_Bb_A_q_Ba_1 __pyx_string_tab[23]
...
static PyObject *__pyx_pw_9integrate_1integrate_cython(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static double __pyx_f_9integrate_integrate_cython(PyObject *__pyx_v_f, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter, CYTHON_UNUSED int __pyx_skip_dispatch) {
  double __pyx_v_acc;
  double __pyx_v_step;
  int __pyx_v_i;
  double __pyx_v_x;
 ...
 *     return acc
*/
    __pyx_t_5 = PyFloat_FromDouble(__pyx_v_acc); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 14, __pyx_L1_error)
    ...
    __pyx_t_8 = PyFloat_FromDouble(__pyx_v_step); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 14, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __pyx_t_9 = PyNumber_Multiply(__pyx_t_6, __pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 14, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __pyx_t_8 = PyNumber_InPlaceAdd(__pyx_t_5, __pyx_t_9); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 14, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
...
*/
  ...
  __Pyx_AddTraceback("integrate.integrate_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
static PyMethodDef __pyx_mdef_9integrate_1integrate_cython = {"integrate_cython", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_9integrate_1integrate_cython, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_9integrate_1integrate_cython(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      for (Py_ssize_t i = __pyx_nargs; i < 4; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("integrate_cython", 1, 4, 4, i); __PYX_ERR(0, 5, __pyx_L3_error) }
      }
    ...
    __pyx_v_f = values[0];
    __pyx_v_a = __Pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
  ...
  __Pyx_RaiseArgtupleInvalid("integrate_cython", 1, 4, 4, __pyx_nargs); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  __pyx_r = __pyx_pf_9integrate_integrate_cython(__pyx_self, __pyx_v_f, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter);
...
static PyObject *__pyx_pf_9integrate_integrate_cython(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_f, double __pyx_v_a, double __pyx_v_b, int __pyx_v_n_iter) {
  ...
  __pyx_t_1 = __pyx_f_9integrate_integrate_cython(__pyx_v_f, __pyx_v_a, __pyx_v_b, __pyx_v_n_iter, 1); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L1_error)
 ...
 *     cdef double step = (b - a) / n_iter
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_9integrate_1integrate_cython, 0, __pyx_mstate_global->__pyx_n_u_integrate_cython, NULL, __pyx_mstate_global->__pyx_n_u_integrate, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 7; } index[] = {{1},{13},{20},{1},{18},{1},{18},{1},{8},{9},{16},{13},{5},{8},{10},{6},{8},{3},{12},{12},{10},{8},{6},{67}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (225 bytes) */
const char* const cstring = "x\332=N\313J\0031\024\255\245\205\372\000\021A\334\270\260\037P\350\027\210\325\265T\301\365!\223\336i\203\231d\232\334H\347\017\262\3142K?\311\345|\206\237`\2442wq\036\334{\016\367A\031\246\255\023L\213\266;\000\353\002\353\356YI\306\013\035\370\215j!|g\244\262\013i\235\r\254\014\371J\352BP\006\354\204\244J\310\217\032\250\203\221\300\3207\010\310\216w\326@y\014\025\212\251\361@#JG\231\306n\202&\240\0341\271\302\242)\256\265-\260\017B\037-\340\211\377WEm\312kA3\300\344\013~\n\035\310\177\217\356\362k?\271I\242\237\334\346q\236\347\247\354\276\256~\316F\323\3238\215\357\351>-\373\331E\\\305*\215\323<=\366\263\313\270O'\351:\255\3762\347q\371\013\037\251k\272";
    PyObject *data = __Pyx_DecompressString(cstring, 225, 1);
...
const char* const bytes = "?integrate.pyx__Pyx_PyDict_NextRefaasyncio.coroutinesbcline_in_tracebackf__func__integrateintegrate_cython_is_coroutineitems__main____module__n_iter__name__pop__qualname____set_name__setdefault__test__values\320\000\035\230Q\330\004\026\220a\330\004\030\230\002\230\"\230C\230r\240\021\360\n\000\005\t\210\005\210U\220!\2201\330\010\014\210B\210b\220\002\220\"\220A\330\010\017\210q\220\001\220\023\220B\220a\330\004\013\2101";
    PyObject *data = NULL;
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  if (unlikely(!tuple_dedup_map)) return -1;
  {
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_integrate_pyx, __pyx_mstate->__pyx_n_u_integrate_cython, __pyx_mstate->__pyx_kp_b_iso88591_Q_a_Cr_U_1_Bb_A_q_Ba_1, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
